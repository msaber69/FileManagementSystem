...
CREATE TABLE `belongs_to` (
  ...
  CONSTRAINT `belongs_to_ibfk_1` FOREIGN KEY (`DocumentID`) REFERENCES `document` (`DocumentID`),
...
INSERT INTO `belongs_to` VALUES (9,1),(1,2),(2,2),(3,2),(10,3),(6,4),(7,4),(8,4),(4,5),(5,5);
